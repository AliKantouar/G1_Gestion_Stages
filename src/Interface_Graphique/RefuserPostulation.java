...
public class RefuserPostulation extends JButton implements ActionListener {
	...
	public RefuserPostulation(String string, Postulation p,ListePostulation lp, Application a, String user)
	{
		this.p=p;
		this.lp=lp;
		this.a=a;
	...
	public void actionPerformed(ActionEvent e) {
		...
		//	Pane.add(new JButton("Accepter"),gbc);
			...
			if(p.getEtat()!='F')
			{
				...
				gbc.gridx++;
				Pane.add(new RefuserPostulation("Refuser",p, this.lp, a, user),gbc);
