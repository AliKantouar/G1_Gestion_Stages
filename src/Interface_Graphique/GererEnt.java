...
public class GererEnt extends JPanel {
	...
	public GererEnt(Application a )
	{
		...
		JLabel lblNewLabel = new JLabel("Liste des entrerprises ("+this.getNbr()+") :");
		...
		ArrayList<Entreprises> list=ListeE();
		afficherliste(list);
	...
	private ArrayList<Entreprises> ListeE() {
		// TODO Auto-generated method stub
		return DAO.listeE();
	}
	
	
	public void afficherliste(ArrayList<Entreprises> entreprises)
	{
		Pane = new JPanel();
